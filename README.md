...
Authenticate with [`aws-actions/configure-aws-credentials`](https://github.com/aws-actions/configure-aws-credentials) to assume an IAM role via OIDC before this step. Credentials are inherited by the job env, so this action picks them up unchanged.
